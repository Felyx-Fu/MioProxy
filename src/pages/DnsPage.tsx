...
export function DnsPage({ profileId }: { profileId: string | null }) {
  ...
  return (
    <section className="page-stack dns-page">
      ...
      <div className="config-flow panel"><span className="flow-step active">1 <b>{t("dns.flowEdit")}</b></span><i>→</i><span className="flow-step">2 <b>{t("dns.flowSaveOverride")}</b></span><i>→</i><span className="flow-step">3 <b>{t("dns.flowValidateLoad")}</b></span></div>
