...
import { mihomoApi, type TunStatus, type TunStatusSnapshot } from "../api/mihomo";
  ...
  return (
    <section className="page-stack tun-page">
      ...
      <div className={`tun-status-card panel ${status}`}>
        ...
        <div className="tun-status-meta"><span>管理员权限 <b>{snapshot?.admin ? "已满足" : "需要提升"}</b></span><span>内核 <b>{coreRunning ? "Running" : "Disabled"}</b></span><span>系统代理 <b>{systemProxyEnabled ? "冲突" : "关闭"}</b></span></div>
      </div>
